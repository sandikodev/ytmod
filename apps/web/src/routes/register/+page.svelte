<script lang="ts">
   ...
   *
   * Mengirim credentials ke POST /auth/register, menyimpan JWT ke localStorage,
...
<main>
  ...
  <p class="link">Sudah punya akun? <a href="{base}/login">Masuk</a></p>
</main>
